...
Add this section to `AGENTS.md`. If the file already exists, append it — don't replace existing content (there may be build commands, linting config, or other project-specific instructions already there that the SDD workflow needs to read).
